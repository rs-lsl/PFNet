...
def create_parser():
    ...
    parser.add_argument('--resume_epoch', default=10000, type=int,
                        help='Name of device to use for tensor computations (cuda/cpu)')
    ...
    parser.add_argument('--pure_test', default=1, type=int,
                        help='Whether to set different seeds for different ranks')
    parser.add_argument('--sample_inte_test', default=6, type=int)
    parser.add_argument('--train_vis', default=0, type=int)

    parser.add_argument('--pred_15day', default=0, type=int)
    ...
    parser.add_argument('--eval_iter', default=10, type=int, help='eval interval in training process')
